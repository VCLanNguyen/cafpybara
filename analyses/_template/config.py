...
path, not `None` and not an HNL/nueCC path), so unfilled use fails
...
DETVAR_DIR = "TODO_SET_ME/replace_with_your_detvar_directory"
DETVAR_DICT_FILES = [DETVAR_DIR + "/detvars.h5"]

# TODO: set if you have an in-time-cosmic sample, else leave None.
INTIME_FILE = None
