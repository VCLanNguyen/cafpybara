...
``rec_key='nuecc'``, base preprocessing, and truth-signal categorisation --
matching this village's historical defaults exactly.
"""
...
def load_mc(
    ...
    ``preprocess_fn=preprocess_mc`` (base, currently a no-op),
